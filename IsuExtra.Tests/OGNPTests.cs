...
namespace IsuExtra.Tests
{
    public class Tests
    {
        ...
        public void RecordingAStudentOnACertainOGNP()
        {
            ...
            string teacherName1 = "Fredi";
            string auditorium1 = "100";
            Lesson lesson1 = new Lesson(teacherName1, auditorium1);
            Lesson[,] tableISU = new Lesson[6, 8];
            tableISU[0, 1] = lesson1;
            tableISU[0, 2] = lesson1;
            string teacherOGNP = "Mikka";
            string auditorium2 = "230";
            Lesson lesson2 = new Lesson(teacherOGNP, auditorium2);
            Lesson[,] tableOGNP1 = new Lesson[6, 8];
            tableOGNP1[0, 1] = lesson2;
            Lesson[,] tableOGNP2 = new Lesson[6, 8];
            tableOGNP2[0, 3] = lesson2;
        ...
        public void GettingAListOfStudentsWhoHaveNotEnrolledInTheOGNP()
        {
            ...
            string auditorium2 = "230";
            Lesson lesson2 = new Lesson(teacherOGNP, auditorium2);
            Lesson[,] tableOGNP = new Lesson[6, 8];
            tableOGNP[0, 3] = lesson2;
            _ognpService.AddTimetable(isuGroup, tableISU);
            ...
            string teacherOGNP1 = "Mikka";
            string auditorium21 = "230";
            Lesson[,] tableOGNP1 = new Lesson[6, 8];
            tableOGNP1[0, 3] = lesson2;
            _ognpService.AddGroupTimetableInOGNP(newOGNP1, newOGNP1.Groups[0], tableOGNP1);
